...
const Host = ({ name, picture }) => {
   ...
   return (
      ...
      <div className="host-container">
         {/* div pour l'image de l'hôte avec la classe "host-image-container" */}
         <div className="host-image-container">
            {/*  balise img pour afficher l'image de l'hôte avec la classe "host-image" */}
            <img className="host-image" src={picture} alt={name} />
         </div>
         {/* div pour afficher le nom de l'hôte avec la classe "host-name" */}
